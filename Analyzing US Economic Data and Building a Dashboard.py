...
df_u = pd.read_csv(links["unemployment"])
...
df_u_greater_than_85 = df_u[df_u["unemployment"] > 8.5]
df_u_greater_than_85.head()
...
unemployment = df_u["unemployment"]
...
title = "Relationship between GDP and Unemploymnet"
...
# @hidden_cell
credentials = {
  "apikey": "tW-p9p0bBTwR8wTqbpMDabW_xk3mOcnwW_IrnX3u1Dxx",
  "cos_hmac_keys": {
    "access_key_id": "78f468ab9a634e26853fd3cc9c85ff9e",
    "secret_access_key": "65609bb05a050880480ed5e6012fcd3c37db30262a69efa5"
  },
  "endpoints": "https://control.cloud-object-storage.cloud.ibm.com/v2/endpoints",
  "iam_apikey_description": "Auto-generated for key 78f468ab-9a63-4e26-853f-d3cc9c85ff9e",
  "iam_apikey_name": "Service credentials-1",
  "iam_role_crn": "crn:v1:bluemix:public:iam::::serviceRole:Manager",
  "iam_serviceid_crn": "crn:v1:bluemix:public:iam-identity::a/c8049ab39aa24bb9b81683c76d300e1f::serviceid:ServiceId-72a7174d-2663-45ad-83a7-f7e07c9beed2",
  "resource_instance_id": "crn:v1:bluemix:public:cloud-object-storage:global:a/c8049ab39aa24bb9b81683c76d300e1f:b363a23c-68d5-488f-b39e-412b90591d50::"
}
